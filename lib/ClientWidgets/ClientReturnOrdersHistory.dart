...
class ClientReturnOrdersHistory extends StatefulWidget {
  @override
  _ClientReturnOrdersHistoryState createState() =>
      _ClientReturnOrdersHistoryState();
}

class _ClientReturnOrdersHistoryState extends State<ClientReturnOrdersHistory> {
  static int page = 1;
