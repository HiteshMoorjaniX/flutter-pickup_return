...
class FancyDialog extends StatefulWidget {
  const FancyDialog(
      {Key key,
        ...
        this.cancelColor = Colors.lightBlueAccent,
        this.okColor = Colors.lightBlueAccent,
        this.ok = " Pickup",
        this.cancel = "Return",
        this.theme = 0})
      : super(key: key);
...
class GifDialogState extends State<FancyDialog> with TickerProviderStateMixin {
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Row(
                      children: <Widget>[
                        theme == 0
                            ? customButton(cancel, cancelColor, cancelFun, 'return')
                            : flatButton(cancel, cancelColor, cancelFun, 'return'),
                        Padding(
                          padding: EdgeInsets.only(
                              left: theme == 0 ? 0.07 * dwidth : 1),
                          child: theme == 0
                              ? customButton(ok, okColor, okFun, 'pickup')
                              : flatButton(ok, okColor, okFun, 'pickup'),
                        )
                      ],
                    ),
                  )
  ...
  Widget customButton(String t, Color c, Function f, var msg) {
      ...
      return Container(
        ...
        child: RaisedButton(
          ...
          onPressed: () => {
            ...
            //f == okFun ? print("Pickup called") : print("Return Called"),
  ...
  Widget flatButton(String t, Color c, Function f, var msg) {
    if(msg == 'pickup'){
      return Container(
        width: 0.29 * dwidth,
        height: 0.15 * dheight,
